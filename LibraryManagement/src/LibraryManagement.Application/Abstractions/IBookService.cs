...
public interface IBookService
{
    ...
    Task<Result<IReadOnlyCollection<BookModel>>> GetAsync(BookQueryRequest request, CancellationToken cancellationToken = default);
    ...
    Task<Result<IReadOnlyCollection<BookModel>>> SearchAsync(BookQueryRequest request, CancellationToken cancellationToken = default);
